...
import com.lgm.LGM_Portfolio.Security.Entity.Usuario;
import com.lgm.LGM_Portfolio.Security.Enums.RolNombre;
import com.lgm.LGM_Portfolio.Security.Service.RolService;
import com.lgm.LGM_Portfolio.Security.Service.UsuarioService;
import com.lgm.LGM_Portfolio.Security.jwt.JwtProvider;
...
public class AuthController {
    ...
    public ResponseEntity<?> nuevo(@Valid @RequestBody NuevoUsuario nuevoUsuario, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            return new ResponseEntity(new Mensaje(" Campos Mal Puesto o Mail invaalido"), HttpStatus.BAD_REQUEST);
        }
